class AddCoordinatesToPaperImages < ActiveRecord::Migration
  def self.up
    add_column :paper_images, :left, :float, :default => 0
    add_column :paper_images, :top, :float, :default => 0
    add_column :paper_images, :angle, :float, :default => 0
    add_column :paper_images, :width, :integer, :default => 377
